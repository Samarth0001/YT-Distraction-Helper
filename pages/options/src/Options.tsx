  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900">
      <div className='pl-4 flex flex-row items-center'>
        ...
        <div className="text-xl font-bold p-4 shadow text-white">Youtube Distraction Helper</div>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="w-64 bg-gray-800 shadow-md">
          <div className="flex flex-col">
            ...
            <button
              className={`p-4 text-left ${activeTab === 'saved_videos' ? 'bg-blue-500 text-white' : 'hover:bg-gray-700 text-white'} transition duration-150 ease-in-out`}
